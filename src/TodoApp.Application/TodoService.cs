...
public sealed class TodoService
{
    ...
    public IEnumerable<Todo> Search(string term)
    {
        ...
        return _repo.All.Where(t => t.Title.Contains(term, StringComparison.OrdinalIgnoreCase));
    }
    ...
    public IEnumerable<Todo> PendingSorted()
    {
        return _repo.All
            .Where(t => !t.IsDone)
            .OrderBy(t => t.DueDate ?? DateOnly.MaxValue); // nulls last
    }
    ...
    public (int total, int done, int pending, bool hasOverdue) Stats()
    {
        ...
        var hasOverdue = _repo.All.Any(t => t.DueDate is { } d && d < today && !t.IsDone);
